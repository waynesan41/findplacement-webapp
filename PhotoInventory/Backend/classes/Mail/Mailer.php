...
class Mailer
{
  ...
  public function sendEmailLink($tokenKey, $apiURL, $email)
  {
    ...
    try {
      ...
      $mail->Host = "mail.717logistics.com"; //Set the SMTP server to send through
      $mail->SMTPAuth = true; //Enable SMTP authentication
      $mail->Username = "wsan@sodecosolutions.com"; //SMTP username
      $mail->Password = "aLy%c;ejIyzg"; //SMTP password
      $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS; //Enable implicit TLS encryption
      $mail->Port = 465; //TCP port to connect to; use 587 if you have set `SMTPSecure = PHPMailer::ENCRYPTION_STARTTLS`

      //Recipients
      $mail->setFrom("wsan@sodecosolutions.com", "Reset Password");
